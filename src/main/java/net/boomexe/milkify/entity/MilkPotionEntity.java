...
public class MilkPotionEntity extends ThrownItemEntity implements FlyingItemEntity {
    ...
    public MilkPotionEntity(EntityType<? extends PotionEntity> entityType, World world) {
        super(entityType, world);
    }

    public MilkPotionEntity(World world, LivingEntity owner) {
        super(EntityType.POTION, owner, world);
    }

    public MilkPotionEntity(World world, double x, double y, double z) {
    ...
    protected void onCollision(HitResult hitResult) {
        ...
        if (!this.world.isClient) {
            ...
            if (this.isLingering()) {
                ...
                this.world.syncWorldEvent(i, this.getBlockPos(), 16777215);
                this.discard();
            } else {
                this.applySplashPotion(list, hitResult.getType() == net.minecraft.util.hit.HitResult.Type.ENTITY ? ((EntityHitResult)hitResult).getEntity() : null);
            }
