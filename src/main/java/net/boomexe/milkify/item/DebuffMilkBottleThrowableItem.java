...
public class DebuffMilkBottleThrowableItem extends Item{// extends PotionItem {
    public DebuffMilkBottleThrowableItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ...
            DebuffMilkPotionEntity potionEntity = new DebuffMilkPotionEntity(world, user);
